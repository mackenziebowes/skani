...
interface HeroProps {
	...
	ctaText?: string;
	ctaHref?: string;
	codes?: Array<{ type: "comment" | "keyword" | "string" | "plain"; content: string }>;
}
...
export function Hero({
	...
	return (
		<section className="py-[120px] pb-[160px] relative">
			<div className="grid grid-cols-2 gap-20 items-start">
				<div className="space-y-10">
					<h1 className="font-serif text-[88px] leading-[0.95] font-normal">
						{heading}
						<br />
						{italicText && (
							<span className="italic font-normal text-muted-foreground">{italicText}</span>
						)}
					</h1>
					<p className="text-lg text-muted-foreground max-w-[480px]">{description}</p>
